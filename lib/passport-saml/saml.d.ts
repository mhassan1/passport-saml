...
import { AudienceRestrictionXML, AuthenticateOptions, AuthorizeOptions, CertCallback, Profile, RequestWithUser, SamlScopingConfig, XMLOutput } from './types';
...
declare class SAML {
    ...
    getNameID(self: SAML, doc: Node, callback: (err: Error | null, nameID?: XMLOutput) => void): any;
